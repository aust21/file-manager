...
def remove_file(can_remove, file_path, file_name) -> None:
	if can_remove:
		sf.pop_up("File found, file location pop up will open.", "File Manager | Remove File", "sound.mp3")
	...
	sf.pop_up("File not found, That's all we know.", "File Manager | Remove File", "sound.mp3")
